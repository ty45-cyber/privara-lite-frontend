...
import { BarChart2, TrendingUp, Shield, Target } from 'lucide-react'
    ...
    <div className="di-panel">
      ...
      <div className="di-stats">
        <div className="di-stat">
          ...
          <span className="di-stat-value di-stat-value--green">
        ...
        <div className="di-stat">
          ...
          <span className="di-stat-value">
            ${(summary.total_capital_deployed / 1000).toFixed(0)}K
          </span>
          <span className="di-stat-sub">approved requests</span>
        </div>
        <div className="di-stat">
          <span className="di-stat-label">CAPITAL PROTECTED</span>
          <span className="di-stat-value di-stat-value--amber">
            ${(summary.capital_protected / 1000).toFixed(0)}K
          </span>
        ...
        <div className="di-stat">
          ...
          <span className="di-stat-value di-stat-value--green">
            {summary.positive_outcomes}/{summary.total_decisions}
          </span>
              ...
              <div className="di-row-left">
                ...
                <div className="di-row-info">
                  ...
                  <span className="di-row-meta">
                    ...
                    Risk at decision: <span className={`di-risk-inline di-risk-inline--${d.risk_score_at_decision.toLowerCase()}`}>
